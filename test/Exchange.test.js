...
contract('Exchange', ([deployer, feeAccount, user1, user2]) =>{ 
    ...
    beforeEach(async () =>{
        ...
        token.transfer(user1, tokens(100), {from: deployer}) //transferring tokens to user1
    ...
    describe('depositing Ether', async () =>{
        ...
        it('emits a Deposit event', async () =>{
            ...
            event.token.toString().should.eq(ETHER_ADDRESS, 'from address is correct')
            event.user.toString().should.eq(user1, 'to address is correct')
    ...
    describe('depositing tokens', () => {
        ...
        describe('success', () => {
            ...
            it('emits a Deposit event', async () =>{
                ...
                log.event.should.eq('Deposit')
                const event = log.args
                event.token.toString().should.eq(token.address, 'from address is correct')
                event.user.toString().should.eq(user1, 'to address is correct')
                event.amount.toString().should.eq(amount.toString(), 'amount is correct')
                event.balance.toString().should.eq(amount.toString(), 'balance is correct')
            })
    ...
    describe('making orders', async () =>{
        ...
        it('emits a Order event', async () =>{
            ...
            event.user.should.eq(user1, 'to address is correct')
    ...
    describe('order actions', async () =>{
        ...
        describe('filling orders', async () =>{
            ...
            describe('success', async () =>{
                ...
                it('executes the trade & charges fees', async () =>{
                    ...
                    balance.toString().should.equal(tokens(0.1).toString(), 'feeAccount recieved')
                })
                ...
                it('emits a Trade event', async () =>{
                    ...
                    event.tokenGive.should.equal(ETHER_ADDRESS, 'tokenGive is correct')
                    event.amountGive.toString().should.equal(ether(1).toString(), 'amountGive is correct')
                    event.userFill.toString().should.equal(user2, 'amountGive is correct')
                    event.timestamp.toString().length.should.be.at.least(1, 'timestamp is present')
                })
        ...
        describe('cancelling orders', async () =>{
            ...
            describe('success', async () =>{
                ...
                it('updated cancelled orders', async () =>{
